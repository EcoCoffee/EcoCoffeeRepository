...
<!-- FRONTEND ELEMENTS -->
<script type="text/javascript" src="../resources/assets/tether/src/js/utils.js"></script>
<script type="text/javascript" src="../resources/assets/tether/src/js/tether.js"></script>
