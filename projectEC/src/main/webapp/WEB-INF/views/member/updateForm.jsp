...
<div class="panel">
    <div class="panel-body">
        ...
        <div class="example-box-wrapper">
            <form id="updateform" action="update" class="form-horizontal bordered-row" method="post" onsubmit="return formCheck();">
                <div class="form-group">
                    <label class="col-sm-3 control-label">ID</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" readonly="readonly" value = "${member.custid}" />
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control popover-button-default" id = "custname" name = "custname" value="${member.name}">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label">COMPANY NAME</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control popover-button-default" id = "name" name = "name" value="${member.custname}">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label">TEL</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control popover-button-default" id = "custtel" name = "custtel" value="${member.custtel}">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label">COMPANY TEL</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control popover-button-default" id = "tel" name = "tel" value="${member.tel}">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control popover-button-default" id = "sample4_roadAddress" name = "road" value="${member.road}">
                    </div>
                </div>  
                <div class="form-group">
                    <label class="col-sm-3 control-label">COMPANY <br> JIBUN ADDRESS</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control popover-button-default" id = "sample4_jibunAddress" name = "jibun" value="${member.jibun}">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label">COMPANY IDNO</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control popover-button-default" id = "idno" name = "idno" readonly="readonly" value="${member.idno}">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <label class="radio-inline">
                            <input type="radio" name="division" value="cafe" onfocus="setRadioCl(event)" <c:if test="${member.division == 'cafe'}">checked</c:if> />
                            CAFE
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="division" value="business" onfocus="setRadioCl(event)" <c:if test="${member.division == 'business'}">checked</c:if> />
                            PICKUP COMPANY
                        </label>
                    </div>
                </div>
