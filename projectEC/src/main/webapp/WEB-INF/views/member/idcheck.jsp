		...
		<div class="example-box-wrapper">
        	<div class="form-group">
        		<div class="col-sm-6" align="center">
        			<form action="idcheck" id = "idcheck" class="form-horizontal bordered-row" method="post" onsubmit="return formCheck();">
                    <input type="text" name="searchId" id="searchId" class="form-control" value="${searchId}" placeholder="Enter ID to Search">
        		...
        		<label class="col-sm-3 control-label">
					...
					<c:if test="${searchResult == null}">
						<p>${searchId} : 사용할 수 있는 ID입니다.&nbsp;
						<button class="btn btn-primary" type="submit" value = "Use this ID" onclick="idSelect('${searchId}')">Use This ID</button></p>
					</c:if>
