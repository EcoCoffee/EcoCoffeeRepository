...
<div class="pad15L pad15R mrg25T"></div><br><br>
...
<div class="panel">
    <div class="panel-body">
        ...
        <div class="example-box-wrapper">
            <form id="joinform" action="join" class="form-horizontal bordered-row" method="post" onsubmit="return formCheck();">
                <div class="form-group">
                    <label class="col-sm-3 control-label">ID</label>
                    <div class="col-sm-6">
                        <input type="text" name="custid" id="custid" class="form-control" maxlength="10" placeholder="Your ID" readonly="readonly"  /><br>
						<span class="input-group-btn">
                         <button class="btn btn-primary" type="button" onclick="idcheckOpen()">Check Your ID</button>
	                    </span>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="password" id="password2" class="form-control" placeholder="Insert Your Same Password" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label">NAME</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control popover-button-default" id = "custname" name = "custname" placeholder="Insert Your Name">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label">COMPANY NAME</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control popover-button-default" id = "name" name = "name" placeholder="Insert Your Company Name">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label">TEL</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control popover-button-default" id = "custtel" name = "custtel" placeholder="Insert Your Tel">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label">COMPANY TEL</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control popover-button-default" id = "tel" name = "tel" placeholder="Insert Your Company Tel">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label">COMPANY <br> POST CODE</label>
                    <div class="col-sm-6">
                        <input type="text" id="sample4_postcode" name="postcode" class="form-control popover-button-default" readonly="readonly" placeholder="Your Company Postcode"><br>
                        <span class="input-group-btn">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control popover-button-default" id = "sample4_roadAddress" name = "road" placeholder="Your Company Road Address">
                    </div>
                </div>  
                <div class="form-group">
                    <label class="col-sm-3 control-label">COMPANY <br> JIBUN ADDRESS</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control popover-button-default" id = "sample4_jibunAddress" name = "jibun" placeholder="Your Company Jibun Address">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label">COMPANY IDNO</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control popover-button-default" id = "idno" name = "idno" placeholder="Insert Your Company Idno">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <label class="radio-inline">
                            <input type="radio" name="division" value="cafe" checked />
                            CAFE
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="division" value="business" />
                            PICKUP COMPANY
                        </label>
                    </div>
                </div>
                ...
                <!-- 좌표넣기 연습 -->
                  <div class="form-group" style="display:none;">
                     ...
                     <div class="col-sm-6">
                     <input type="text" class="form-control popover-button-default" id="lat" name="lat"> 
                     </div>
                     <br><br>
                     <label class="col-sm-3 control-label">Lng</label>
                     <div class="col-sm-6">
                     <input type="text" class="form-control popover-button-default" id="lng" name="lng"> 
                     </div>
